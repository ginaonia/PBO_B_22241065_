...
public class Main {
    public static void main(String[] args) {
             ...
             Persegi persegi = new Persegi(8.0f);
             persegi.display();
             ...
             Lingkaran lingkaran = new Lingkaran(11.0f);
             lingkaran.display();
             ...
             PersegiPanjang persegiPanjang = new PersegiPanjang(9.0f, 5.0f);
             persegiPanjang.display();
             System.out.println("Luas Persegi Panjang: " + persegiPanjang.hitungLuas());
             System.out.println("Keliling Persegi Panjang: " + persegiPanjang.hitungKeliling());
             System.out.println();
  // Menggunakan kelas Segitiga
  Segitiga segitiga = new Segitiga(7.0f, 9.0f, 11.0f, 13.0f, 17.0f);
  segitiga.display();
